...
def dibujar(screen, palabraUsuario, palabraActual, puntos, segundos):
    ...
    #muestra la leyenda "Ingrese la palabra en silabas:"
    screen.blit(defaultFont.render("Ingrese la palabra en silabas:", 1, COLOR_TEXTO), (80, 550))

    #muestra lo que escribe el jugador
    screen.blit(defaultFont.render(palabraUsuario, 1, COLOR_TEXTO), (400, 550))
    ...
    if segundos==0:
        ren2 = defaultFont.render("GAME OVER", 50, COLOR_TEXTO)
    screen.display (ren,(ANCHO//2))
